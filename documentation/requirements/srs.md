...
[TBD_Discuss] согласовать количественные KPI (точность ответов, скорость обучения, качество поиска аналогов).
...
- Входные данные: сканы и фотографии (JPG/PNG), PDF, сметные форматы ARP/GSFX, чертежи DWG/DXF, текстовые и табличные файлы, нормативные документы (ГОСТы).  
...
См. подробные сценарии в документе `documentation/requirements/use-cases.md`. Краткая сводка (ядро интеллектуальной системы):  
...
- FR-KNOW-03: Система ежедневно проверяет обновления нормативной базы (ГОСТы, регламенты).  
