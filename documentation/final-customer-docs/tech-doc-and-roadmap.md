...
- Требования:
  ...
  - Безопасность: air-gapped, ACL по ролям/проектам, аудит, шифрование при хранении/передаче, управление токенами API.
  - Мониторинг: время/ошибки шагов, состояние очередей, статус моделей, дисковое пространство, доступность сервисов.
- Комментарии:
  - Согласовать приоритеты интеграций и список внешних систем.
  - Уточнить формат хранения базы знаний/нормативки и ретенцию.
...
- Комментарии:
  - Нужны политики повторного индексирования при обновлении контекста.
  - Требуется согласовать хранение и очистку индексов по проектам.
...
- Требования:
  ...
  - Уточнить CPU/GPU, RAM, диск для целевых SLA; организовать хранение артефактов/логов/версий.
  - Лимиты: размер файлов/страниц/листов; ретенция логов/артефактов; бэкап/restore процедурно.
- Комментарии:
...
- Требования:
  ...
  - CI/CD (локальный): сборка/тест/деплой контейнеров; контроль версий образов/конфигов; процедуры обновления/отката.
- Комментарии:
