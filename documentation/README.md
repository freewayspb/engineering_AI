...
### `/docs/tooling/` - Инструменты и настройки
| Файл | Описание | Статус |
|------|----------|--------|
| `transcription/` | Скрипты для транскрипции встреч | ✅ Готов |
| `translation/` | Материалы по переводу | ✅ Готов |
| `setup/` | Настройки инструментов (Whisper, диаризация) | ✅ Готов |
